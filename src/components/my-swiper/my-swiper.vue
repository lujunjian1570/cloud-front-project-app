  ...
  computed: {
    justifyContent() {
      if (this.indicatorPos == 'topLeft' || this.indicatorPos == 'bottomLeft') {
        return 'flex-start'
      } else if (this.indicatorPos == 'topCenter' || this.indicatorPos == 'bottomCenter') {
        return 'center'
      } else if (this.indicatorPos == 'topRight' || this.indicatorPos == 'bottomRight') {
        return 'flex-end'
      } else {
        return ''
      }
