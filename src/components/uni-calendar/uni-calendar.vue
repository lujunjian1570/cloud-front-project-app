<template>
  <view class="uni-calendar" @touchmove.stop.prevent="clean">
    <view v-if="!insert&&show" class="uni-calendar__mask" :class="{'uni-calendar--mask-show':aniMaskShow}" @click="clean" />
      ...
      <view class="uni-calendar__box">
        ...
        <view v-for="(item,weekIndex) in weeks" :key="weekIndex" class="uni-calendar__weeks">
          <view v-for="(weeks,weeksIndex) in item" :key="weeksIndex" class="uni-calendar__weeks-item">
            <uni-calendar-item :weeks="weeks" :calendar="calendar" :selected="selected" :lunar="lunar" @change="choiceDate" />
          </view>
        </view>
      </view>
    </view>
