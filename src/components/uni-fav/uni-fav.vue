<template>
  <view :class="[circle === true || circle === 'true' ? 'uni-fav--circle' : '']" :style="[{ backgroundColor: checked ? bgColorChecked : bgColor }]" class="uni-fav" @click="onClick">
    <!-- #ifdef MP-ALIPAY -->
    ...
    <!-- #endif -->
    <!-- #ifndef MP-ALIPAY -->
    <uni-icons v-if="!checked && (star === true || star === 'true')" :color="fgColor" :style="{color: checked ? fgColorChecked : fgColor}" class="uni-fav-star" size="14" type="star-filled" />
    <!-- #endif -->
