<template>
  <view id="list" ref="list" class="uni-indexed-list">
      ...
      <cell v-for="(list, idx) in lists" :key="idx" :ref="'uni-indexed-list-' + idx">
        ...
        <scroll-view :scroll-into-view="scrollViewId" class="uni-indexed-list__scroll" scroll-y>
          <view v-for="(list, idx) in lists" :id="'uni-indexed-list-' + idx" :key="idx">
            <!-- #endif -->
            <uni-indexed-list-item :list="list" :loaded="loaded" :idx="idx" :show-select="showSelect" @itemClick="onClick" />
            <!-- #ifndef APP-NVUE -->
          </view>
        </scroll-view>
        <!-- #endif -->
    ...
    <!-- #endif -->
    <view :class="touchmove ? 'uni-indexed-list__menu--active' : ''" class="uni-indexed-list__menu" @touchstart="touchStart" @touchmove.stop.prevent="touchMove" @touchend="touchEnd">
