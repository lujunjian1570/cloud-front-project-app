<template>
  <view class="uni-searchbar">
    <view :style="{borderRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box" @click="searchClick">
      ...
      <!-- #endif -->
      <input v-if="show" v-model="searchVal" :focus="showSync" :placeholder="placeholder" :maxlength="maxlength" class="uni-searchbar__box-search-input" confirm-type="search" type="text" @confirm="confirm">
    ...
    <text v-if="cancelButton ==='always' || show && cancelButton ==='auto'" class="uni-searchbar__cancel" @click="cancel">{{ cancelText }}</text>
  </view>
</template>
