<template>
  <view class="uni-swipe">
    ...
    <view class="uni-swipe_content">
      ...
      <view ref="selector-content-hock" class="selector-query-hock" :class="{'ani':uniShow}" :style="{transform:moveLeft}" @touchstart="touchstart" @touchmove="touchmove" @touchend="touchend">
