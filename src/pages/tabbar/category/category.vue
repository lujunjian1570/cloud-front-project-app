...
<script>
import classifyData from '@/common/js/classifyData.js'
export default {
  data() {
    return {
  ...
  methods: {
    ...
    async observer() {
      ...
      await this.tabbar.map((val, index) => {
    ...
    async rightScroll(e) {
      ...
      setTimeout(() => { // 节流
        ...
        const scrollHeight = e.detail.scrollTop + this.menuHeight / 2
